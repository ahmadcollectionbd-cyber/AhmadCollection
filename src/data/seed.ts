...
export const banners: Banner[] = [
  ...
  {
    id: 'b-2',
    title: 'Pure Sundarbans Honey',
    subtitle: '100% raw, hive-direct honey & honeycomb — delivered to your door',
    image:
      'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=1600&q=80',
    ctaLabel: 'Shop Honey',
    ctaHref: '/shop?cat=honey',
    active: true,
    order: 2,
  },
  {
    id: 'b-3',
    title: 'Satkhira Mango Season',
    subtitle: 'Pre-order Himsagar, Langra & Amrupali mangoes — naturally ripened, no carbide',
    image:
      'https://images.unsplash.com/photo-1591073113125-e46713c829ed?w=1600&q=80',
