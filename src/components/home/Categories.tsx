    ...
    <section className="section mt-10">
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide sm:gap-4">
        ...
        <div className="flex-shrink-0">
          <Link
            to="/shop"
            className="group flex h-full w-32 flex-col items-center justify-center rounded-2xl border border-dashed border-brand-300 bg-brand-50/50 p-4 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:bg-brand-50 hover:shadow-lg dark:border-brand-400/30 dark:bg-brand-500/10 sm:w-36"
          >
