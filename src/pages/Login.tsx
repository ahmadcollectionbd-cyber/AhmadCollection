...
import { describeAuthError, mapFirebaseUser, signInEmail, signInGoogle } from '../lib/auth';
...
export function Login() {
  ...
  async function onSubmit(values: Form) {
    try {
      const fbUser = await signInEmail(values.email, values.password);
        ...
        <div className="card p-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-3">
            ...
            <div>
              ...
              <input className="input mt-1" type="password" placeholder="••••••••" autoComplete="current-password" {...register('password')} />
